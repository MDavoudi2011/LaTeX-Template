...
\titleformat{\section}[block]
  {\needspace{4\baselineskip}\Huge\bfseries\color{ThemePrimary}}
  {\thesection}
  {1em}
  {#1\\[0.5ex]{\color{ThemeSecondary!50}\titlerule[1.5pt]}}
...
\renewcommand{\cftchapfont}{\bfseries\large\color{ThemePrimary}}
\renewcommand{\cftchappagefont}{\bfseries\large\color{ThemePrimary}}

\renewcommand{\cftsecfont}{\color{ThemePrimary!90!black}}
\renewcommand{\cftsecpagefont}{\color{ThemePrimary!90!black}}
